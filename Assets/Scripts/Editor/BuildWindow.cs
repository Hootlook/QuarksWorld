...
namespace QuarksWorld
{
    public class BuildWindow : EditorWindow
    {
        ...
        void DrawLevelSelect()
        {
            ...
            GUILayout.Label("Boot Scene", GUILayout.ExpandWidth(true));
            ...
            if (openLevel != null)
            {
                UnityEditor.SceneManagement.EditorSceneManager.OpenScene(AssetDatabase.GetAssetPath(openLevel.mainScene), UnityEditor.SceneManagement.OpenSceneMode.Single);
            }
        }
        ...
        void DrawBuildTools()
        {
            ...
            if (GUILayout.Button("Open build folder"))
            {
                if (Directory.Exists(windowsPath))
                {
                    ...
                    {
                        StartInfo = new System.Diagnostics.ProcessStartInfo("explorer.exe", windowsPath)
                    };
                    p.Start();
                }
                else
