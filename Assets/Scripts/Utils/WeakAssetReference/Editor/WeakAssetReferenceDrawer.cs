...
namespace QuarksWorld
{
    ...
    public class WeakAssetReferenceDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
        {
            ...
            var assetType = System.Attribute.GetCustomAttribute(fieldInfo, typeof(AssetTypeAttribute)) is AssetTypeAttribute assetTypeProperty ? assetTypeProperty.assetType : typeof(Object);
            ...
            if (reference.IsSet())
            {
                var path = AssetDatabase.GUIDToAssetPath(reference.GetGuidStr());
            ...
            pos = EditorGUI.PrefixLabel(pos, GUIUtility.GetControlID(FocusType.Passive), new GUIContent(label.text));
